...
if __name__ == "__main__":
    ...
    if args_v.input_file is not None:
        ...
        s.send_job(f"simulation_{ID_name}",f"python3 -c 'from simulations.simulate_neuron import main; main()' {cur_args}",mem='16G')
        ...
        for i in range(args_v.amount):
            ...
            s.send_job(f"simulation_{ID}",f"python3 -c 'from simulations.simulate_neuron import main; main()' {cur_args}",mem='16G')
