...
ax_res=100
capa_mb=1
erev_pas=-87.09854995116433
conduct_pas=5.94759047256079e-05
erev_na=50
erev_k=-90
...
for sec in axonal:
    ...
    sec.vshifth_NaTg=10
    sec.slopem_NaTg=9
    sec.gNaTgbar_NaTg=1.2501308003682468
    sec.insert("Nap_Et2")
    sec.gNap_Et2bar_Nap_Et2=0.00230413994997827
    sec.insert("K_Pst")
    sec.gK_Pstbar_K_Pst=0.49865274649106134
    sec.insert("K_Tst")
    sec.gK_Tstbar_K_Tst=0.09105751201219771
    sec.insert("SKv3_1")
    sec.gSKv3_1bar_SKv3_1=0.014299636643028302
    sec.insert("Ca_HVA2")
    sec.gCa_HVAbar_Ca_HVA2=0.0003141525357846478
    sec.insert("Ca_LVAst")
    sec.gCa_LVAstbar_Ca_LVAst=4.999999546340117e-12
    sec.insert("SK_E2")
    sec.gSK_E2bar_SK_E2=0.009284291868475084
    sec.insert("CaDynamics_DC0")
    sec.decay_CaDynamics_DC0=299.99999986
    sec.gamma_CaDynamics_DC0=0.028268924492546768                
    sec.ena=erev_na
    sec.ek=erev_k
...
for sec in somatic:
    ...
    sec.vshifth_NaTg=15
    sec.slopem_NaTg=7
    sec.gNaTgbar_NaTg=0.24254740793161678
    sec.insert("K_Pst")
    sec.gK_Pstbar_K_Pst=0.055732995347501
    sec.insert("K_Tst")
    sec.gK_Tstbar_K_Tst=0.010997539695773328
    sec.insert("SKv3_1")
    sec.gSKv3_1bar_SKv3_1=0.2122986722144376
    sec.insert("Ca_HVA2")
    sec.gCa_HVAbar_Ca_HVA2=0.0005065569053716721
    sec.insert("Ca_LVAst")
    sec.gCa_LVAstbar_Ca_LVAst=0.001530213401419813
    sec.insert("SK_E2")
    sec.gSK_E2bar_SK_E2=0.09343647620958612
    sec.insert("CaDynamics_DC0")
    sec.decay_CaDynamics_DC0=25.0612349984587
    sec.gamma_CaDynamics_DC0=0.02915973426431621
    sec.insert("Ih")
    for seg in sec:
        distance_from_soma = h.distance(cell.soma[0](0.5), seg)
        seg.gIhbar_Ih=(-0.8696 + 2.087*np.exp(distance_from_soma*0.0031))*2.0855685689787803e-05
    sec.ena=erev_na
    sec.ek=erev_k
...
for sec in apical:
    ...
    for seg in sec:
        distance_from_soma = h.distance(cell.soma[0](0.5), seg)
        sec.gNaTgbar_NaTg=np.exp(distance_from_soma*-0.026746966048881812)*0.00915989268381169
    sec.insert("SKv3_1")
    sec.gSKv3_1bar_SKv3_1=0.0021367807712141884
    sec.insert("Ca_HVA2")
    sec.gCa_HVAbar_Ca_HVA2=3.6383423665734135e-06
    sec.insert("Ca_LVAst")
    sec.gCa_LVAstbar_Ca_LVAst=0.0006674855292281087
    sec.insert("CaDynamics_DC0")
...
for sec in basal:
    ...
    sec.e_pas=erev_pas
    sec.insert("Ca_HVA2")
    sec.gCa_HVAbar_Ca_HVA2=7.041188579054539e-05
    sec.insert("CaDynamics_DC0")
    sec.gamma_CaDynamics_DC0=0.04513201351931105
    sec.insert("Ca_LVAst")
    sec.gCa_LVAstbar_Ca_LVAst=0.0002278777077078115
    sec.insert("Ih")
    for seg in sec:
        distance_from_soma = h.distance(cell.soma[0](0.5), seg)
        seg.gIhbar_Ih=(-0.8696 + 2.087*np.exp(distance_from_soma*0.0031))*2.0855685689787803e-05
